		...
		<div class="container" id="userModeContainer">
			<div id="resetPasswordDialog" style="display: none;">
				<form class="form-wrapper">
					<input type="text" id="search" placeholder="请输入新的密码" required data-bind="value : newPasswordToReset"> <a type="password" class="small blue button" data-bind="click : resetPassword"> <i class="icon-circle-arrow-right"></i>提交
					</a>
				</form>
			</div>
			<div class="content" id="userRolesManagementDialog" style="display: none;">
				<div data-bind="foreach : allRoles">
					<label class="input-checkbox" for="employeeProblem"> <input class="icheckbox" type="checkbox" name="userRoleInput" data-bind="value : name, click : $root.updateUserRole, checked : $root.selectedUserRoles" /> <span data-bind="text : description"></span>
					</label>
				</div>
			</div>
			<div class="row">
								...
								<table class="infoTable">
									...
									<tbody data-bind="foreach : users">
										<tr>
											...
											<td style="text-align: center"><span data-bind="visible : active">激活</span> <span data-bind="visible : !active">关闭</span></td>
											<td style="text-align: center"><a title="分配角色" data-bind="click : $root.openAssignRolesDialog" style="margin-left: 10px;" href="#"><i class="icon-user small icon-blue"></i></a> <a title="重置密码" data-bind="click : $root.openResetPasswordDialog" style="margin-left: 10px;" href="#"><i
													class="icon-pencil small icon-orange"></i></a> <a title="关闭用户" data-bind="click : $root.disactiveUser" style="margin-left: 10px;" href="#"><i class="icon-trash small icon-red"></i></a></td>
										</tr>
									</tbody>
								</table>
							</div>
				...
				<div id="userManagementDialog" class="content" title="用户管理" style="display: none;" data-bind="with : selectedUser">
					<div class="row">
						<label>姓名</label> <input id="userNameInput" type="text" class="addon-postfix" placeholder="请输入姓名" data-bind="value : name" />
					</div>
					<div class="row">
						<label>用户名</label> <input type="text" class="addon-postfix" placeholder="请输入用户名" data-bind="value : username" />
					</div>
					<div class="row">
						<label>密码</label> <input type="password" class="addon-postfix" placeholder="请输入密码" data-bind="value : password" />
					</div>
				</div>
			</div>
		</div>
			...
			var UserModel = function() {
				...
				self.resetPassword = function() {
					$.ajax({
						...
						data : {
							newPasswordToReset : self.newPasswordToReset(),
							userJson : JSON.stringify(self.selectedUser())
						},
						type : 'POST',
						success : function(data) {
