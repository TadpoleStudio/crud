...
public class RestWebServiceCreator {

	public static String generateCode(JpaEntityDefinition jpaEntityDefinition) {

		try {
			Template template = SystemUtils.getFTLTemplateConfiguration().getTemplate("rest.ftl");
	...
	public static String getSourceFileName(JpaEntityDefinition jpaEntityDefinition) {
		...
		String jpaEntityPackagePath = SystemPropertiesReader.getString("rest-package");
		String filePath = jpaEntityPackagePath + jpaEntityDefinition.getJavaClassName() + "Resource.java";
